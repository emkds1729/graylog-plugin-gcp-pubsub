...
module.exports = new PluginWebpackConfig(__dirname, 'org.graylog.plugins.gcppubsub.GraylogPubSubInputPluginPlugin', loadBuildConfig(path.resolve(__dirname, './build.config')), {
